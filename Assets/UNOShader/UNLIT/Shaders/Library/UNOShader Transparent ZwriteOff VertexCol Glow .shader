//Version=1.1
Shader"UNOShader/Unlit Library/Self-Illumin/Transparent ZwriteOff VertexCol Glow "
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
			...
			fixed4 frag (v2f i) : COLOR  // i = in gets info from the out of the v2f vert
			{
				...
				result = lerp (fixed4(GlowColor.rgb,0),fixed4(GlowResult.rgb * _GlowV,1),GlowAmount);
