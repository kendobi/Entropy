//Version=1.1
Shader"UNOShader/Unlit Library/Diffuse ShadowAmbient Light0 AmbientLight "
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
			...
			v2f vert (customData v)
			{
				...
				fixed3 lightAmbient = UNITY_LIGHTMODEL_AMBIENT.rgb * 2;
				fixed3 light0Dir = _LightColor0.rgb;
				fixed3 lights = lightAmbient + light0Dir;
